...
<div class="container">
    ...
    <form action="{{ route('seller.orders.update', $order) }}" method="POST" autocomplete="off">
        @csrf
        @method('PATCH')
        <div class="row">
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="content" name="content" class="form-control editor @error('content') is-invalid @enderror" required>{!! $order->content !!}</textarea>
                            @error('content')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
